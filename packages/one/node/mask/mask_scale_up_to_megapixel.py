...
class OneMaskScaleUpToMegapixelInputs(TypedDict):
	device: str
	mask: Tensor
	megapixel: int
	method: ScaleMethod

class OneMaskScaleUpToMegapixel(io.ComfyNode):
	@classmethod
	def define_schema(cls) -> io.Schema:
		return io.Schema(
			node_id = "OneMaskScaleUpToMegapixel",
			category = "One/Mask",
			inputs = [
	...
	@classmethod
	def execute(cls, **kwargs: Unpack[OneMaskScaleUpToMegapixelInputs]) -> io.NodeOutput:
		mask = kwargs["mask"]
